...
export const fetchFullPost = (id) => {
    return dispatch => {
        ...
        axios.get('https://seegall-d5efa.firebaseio.com/posts/' + id + '.json')
            .then(response => {
...
export const uploadResponse = (id, email, value) => {
    return dispatch => {
        ...
        axios.post('https://seegall-d5efa.firebaseio.com/posts/' + id + '/responses.json', responseData)
            .then(response => {
                console.log(response.data);
...
export const deleteResponse = (id, responseID) => {
    return dispatch => {
        ...
        axios.delete('https://seegall-d5efa.firebaseio.com/posts/' + id + '/responses/' + responseID + '/.json')
            .then(response => {
...
export const deletePost = (id) => {
    return dispatch => {
        ...
        axios.delete('https://seegall-d5efa.firebaseio.com/posts/' + id + '/.json')
            .then(response => {
                console.log(response);
