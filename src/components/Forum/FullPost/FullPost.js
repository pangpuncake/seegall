...
class FullPost extends Component {
    ...
    submitHandler = (event) => {
        if (this.props.email) {
            ...
            this.props.uploadResponse(this.props.id, this.props.email, this.state.controls.response.value);
            this.setState({
                controls: {
                    response: {
                        elementType: 'input',
    ...
    loadData() {
        if (this.props.match.params.id) {
            if (!this.props.loadedPost || (this.props.loadedPost && this.props.id !== this.props.match.params.id)) {
...
const mapDispatchToProps = dispatch => {
    return {
        ...
        uploadResponse: (id, email, value) => dispatch(actions.uploadResponse(id, email, value)),
